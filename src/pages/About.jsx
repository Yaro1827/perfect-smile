  ...
  return (
    ...
    >
      <AboutSection
        ...
        description="У 2021 відкрилась наша клініка, це було невеличке приміщення з двома кімнатами. Нашою перевагою була не кількість крісел, а увага до пацієнтів. З часом ми розширювалися, оновлювали наш інвентар сучасних технологій, наша ціль була зробити Perfect Smile стоматологічною клінікою з найсучаснішими технологіями і підтримкою усіх європейських стандартів."
        image={History}
      />
